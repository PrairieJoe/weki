...
export async function installComponent({ rootDirectory, manifest, componentId, version, fetchImpl = globalThis.fetch, publicKey = null, appVersion = "1.0.0", baseUrl = null }) {
