...
- 신규 설치 온보딩 투어를 실제 이용 순서인 문서 등록 → 검색 → 결과·근거 → 처리 모드 설정 → MYBOX로 재배치했습니다.
- 온보딩 오버레이를 중성 회색 반투명 스타일로 변경하고 스크림·Spotlight에 같은 토큰을 적용했습니다.
- 설정·운영 화면의 고품질 검색 구성요소를 구성요소명·상태·작업 고정 열 Grid로 정렬했습니다. 버튼이 없는 행도 작업 열을 예약합니다.
- 모바일 폭에서 런타임 카드와 헤더가 화면 밖으로 넘치지 않도록 최소 폭과 반응형 열을 보완했습니다.

## 검증

- `npm test`: 200 passed / 0 failed / 0 skipped
- `npm run test:e2e`: 2 passed / 0 failed / 0 skipped
- 온보딩·런타임 UI E2E: 1024×700, 1360×900 및 320·375·580px 폭 검증 통과
- `npm run build`: 통과
- `npm run dist:win`: 통과
- 패키지 버전 `1.2.2`, SHA-256 및 SHA-512 검증 완료

## 설치파일

- 파일: `Weki-1.2.2-Setup.exe`
- 크기: 232,101,203 bytes
- SHA-256: `87227A153886E15B3D991F821B1FEFF9B6A0F8E0197D04B53DC6C5BDAB1684AC`
- SHA-512: `D1C4193E8A0DC6D4B6381676911609720CCBF461F51913C88D2B3D3957A46AAEF2E705BD42D5D8F465ECB4D4D3DE287582E3C35C27CFF35181A0590BB4EFB845`
